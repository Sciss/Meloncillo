 ...
 *  Calculates the bitwise (inclusive) OR or two integers. Call:
 *  <pre>
 *  (logior <var>&lt;int1&gt;</var> <var>&lt;int2&gt;</var>)
 *  </pre>
 *
 *  @author		Hanns Holger Rutz
 *  @version	0.75, 10-Jun-08
 */
public class LogIORPrimitive
extends BasicLispPrimitive
{
	public LogIORPrimitive( AdvancedJatha lisp )
	{
		super( lisp, "LOGIOR", 2, 2 );
	}
